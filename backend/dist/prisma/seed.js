...
const dataURIs = tslib_1.__importStar(require("./data_uri.json"));
const authors_json_1 = tslib_1.__importDefault(require("./authors.json"));
...
async function main() {
    ...
    let users = immutable_1.List();
    let books = immutable_1.List();
    let genres = immutable_1.Map();
                ...
                connectOrCreate: {
                    where: {
                        firstName_middleName_lastName: {
                            firstName: authors_json_1.default.harperLee.firstName,
                            middleName: authors_json_1.default.harperLee.middleName,
                            lastName: authors_json_1.default.harperLee.lastName
                        }
                    },
                    create: authors_json_1.default.harperLee
                }
            }
        },
        create: {
        ...
        update: {
            authors: {
                connectOrCreate: {
                    where: {
                        firstName_middleName_lastName: {
                            firstName: authors_json_1.default.jSMills.firstName,
                            middleName: authors_json_1.default.jSMills.middleName,
                            lastName: authors_json_1.default.jSMills.lastName
                        },
                    },
                    create: authors_json_1.default.jSMills
                }
            }
        },
        create: {
